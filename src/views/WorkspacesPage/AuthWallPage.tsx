  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {APPLICATION_LOCALE.pages.authWall.title}
        </Typography>
        ...
        >
          {APPLICATION_LOCALE.pages.authWall.description}
        </Typography>
        ...
        >
          ...
          >
            {APPLICATION_LOCALE.pages.authWall.buttons.signIn}
          </Button>
          ...
          >
            {APPLICATION_LOCALE.pages.authWall.buttons.register}
          </Button>
        </Box>
      </Paper>
    </Box>
