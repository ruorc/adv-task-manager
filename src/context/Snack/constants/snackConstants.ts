 ...
 */
export type SnackSeverity = (typeof SNACKS)[keyof typeof SNACKS];

/**
 * Default fallback notification severity applied when none is explicitly specified.
 */
export const DEFAULT_SNACK_SEVERITY: SnackSeverity = SNACKS.INFO;
